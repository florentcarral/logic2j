...
public class YahooMapLibraryTest extends PrologTestBase {
    ...
    public void yahoomap() throws Exception {
        ...
        System.out.println("\n 4th test : ");
        assertNSolutions(1,
                "Y='12.05435', yahoomap(X, Y, '13.2345', 'MY_API_KEY'), write(X), write('    and Y =>'), write(Y)");
        System.out.println("\n 5th test : ");
        assertNoSolution("yahoomap(X,'0', '0', 'MY_API_KEY')");
        System.out.println("\n 6th test : ");
        assertNSolutions(
                1,
                "yahoomap('244 chemin de la Cassine,73000 Chambéry', LATITUDE, LONGITUDE, 'MY_API_KEY'), write(LATITUDE), write(LONGITUDE)");
        System.out.println("\n 7th test : ");
        assertNSolutions(
                1,
                "yahoomap('244 chemin de la Cassine,73000 Chambéry', LATITUDE, LONGITUDE, 'MY_API_KEY'), yahoomap(Address, LATITUDE, LONGITUDE, 'MY_API_KEY'), write(Address)");
        System.out.println("\n 8th test : ");
